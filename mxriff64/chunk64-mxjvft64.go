...
// MAGIX JPEG Video Frame Table.
type Chunk64MXJVFT64 struct {
	*Accessor
...
func (c *Chunk64MXJVFT64) Identifier() Identifier64 {
	return Identifier64{'M', 'X', 'J', 'V', 'F', 'T', '6', '4'}
}

// Returns the total length of the chunk, including headers and such.
func (c *Chunk64MXJVFT64) Length() int64 {
	return 8 + 8 + c.Header.DataLength
}

// Returns an io.Reader with the chunk data.
func (c *Chunk64MXJVFT64) DataReader() (io.Reader, error) {
...
func (*Chunk64MXJVFT64) BuildChunk(a *Accessor) (Chunk64, error) {
	if a == nil {
		return nil, fmt.Errorf("accessor is nil")
	}

	c := &Chunk64MXJVFT64{Accessor: a}
...
func init() {
	MustRegisterChunk64(&Chunk64MXJVFT64{})
}
