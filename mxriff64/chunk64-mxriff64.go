...
type Chunk64MXRIFF64 struct {
	*Accessor

	Header struct {
		DataLength int64
		FormType   FormType // Type of data that is stored in this MXRIFF64 container.
	}
...
func (c *Chunk64MXRIFF64) Identifier() Identifier64 {
	return Identifier64{'M', 'X', 'R', 'I', 'F', 'F', '6', '4'}
}

// Returns the total length of the chunk, including headers and such.
func (c *Chunk64MXRIFF64) Length() int64 {
...
func (c *Chunk64MXRIFF64) Chunks() iter.Seq2[Chunk64, error] {
...
func (*Chunk64MXRIFF64) BuildChunk(a *Accessor) (Chunk64, error) {
	if a == nil {
		return nil, fmt.Errorf("accessor is nil")
	}

	c := &Chunk64MXRIFF64{Accessor: a}
...
func init() {
	MustRegisterChunk64(&Chunk64MXRIFF64{})
}
