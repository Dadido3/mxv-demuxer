...
// MAGIX JPEG Video Audio Frame.
type Chunk64MXJVAF64 struct {
	*Accessor
...
type Chunk64MXJVAF64Data struct {
	...
	StartSample     uint64 // The start sample of this audio frame.
	Samples         uint32 // Number of samples contained in this audio frame.
}

// Returns the identifier of the chunk.
func (c *Chunk64MXJVAF64) Identifier() Identifier64 {
	return Identifier64{'M', 'X', 'J', 'V', 'A', 'F', '6', '4'}
}

// Returns the total length of the chunk, including headers and such.
func (c *Chunk64MXJVAF64) Length() int64 {
...
func (*Chunk64MXJVAF64) BuildChunk(a *Accessor) (Chunk64, error) {
	if a == nil {
		return nil, fmt.Errorf("accessor is nil")
	}

	c := &Chunk64MXJVAF64{Accessor: a}
...
func init() {
	MustRegisterChunk64(&Chunk64MXJVAF64{})
}
